...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Mantém CRÉDITOS ativo quando estiver em creditos.html
    var creditosDropdown = document.getElementById("creditosDropdown");

    if (creditosDropdown && page === "creditos.html") {
        creditosDropdown.classList.add("active");
    }
    ...
    if (form) {
        ...
        form.addEventListener("submit", function (e) {
            ...
            [name, email, phone, rating, comment].forEach(function (f) {
            ...
            if (feedback) {
                ...
                feedback.innerHTML =
                    ...
                    "Obrigado, <strong>" +
                    name.value.trim() +
                    "</strong>! Sua mensagem foi recebida. " +
                    "Avaliação: <strong>" +
                    rating.value +
                    "/5</strong>.";
        ...
        formEn.addEventListener("submit", function (e) {
            ...
            if (feedback) {
                ...
                feedback.innerHTML =
                    ...
                    "Thank you, <strong>" +
                    name.value.trim() +
                    "</strong>! Your message was received. " +
                    "Rating: <strong>" +
                    rating.value +
                    "/5</strong>.";
    ...
    if (collapse && toggler) {
        ...
        document.querySelectorAll(".navbar-nav .nav-link").forEach(function (link) {
            ...
            link.addEventListener("click", function () {
                ...
                // Não fecha o menu ao clicar em CRÉDITOS
    ...
    document.querySelectorAll('a[href^="#"]').forEach(function (a) {
        ...
        a.addEventListener("click", function (e) {
            ...
            // Ignora o href="#" do botão CRÉDITOS
            if (!href || href === "#") {
                return;
            }
